...
${OBJECTDIR}/src/Core/Threads/MotionThread.o: src/Core/Threads/MotionThread.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -Isrc -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Core/Threads/MotionThread.o src/Core/Threads/MotionThread.cpp

${OBJECTDIR}/src/Core/Threads/NetworkThread.o: src/Core/Threads/NetworkThread.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Core/Threads
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -Isrc -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Core/Threads/NetworkThread.o src/Core/Threads/NetworkThread.cpp
...
${OBJECTDIR}/src/Core/Threads/MotionThread_nomain.o: ${OBJECTDIR}/src/Core/Threads/MotionThread.o src/Core/Threads/MotionThread.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Isrc -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Core/Threads/MotionThread_nomain.o src/Core/Threads/MotionThread.cpp;\
	else  \
...
${OBJECTDIR}/src/Core/Threads/NetworkThread_nomain.o: ${OBJECTDIR}/src/Core/Threads/NetworkThread.o src/Core/Threads/NetworkThread.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Isrc -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Core/Threads/NetworkThread_nomain.o src/Core/Threads/NetworkThread.cpp;\
	else  \
